...
const BASH_RULES: LanguageRules = {
	keywords: new Set([
		...
		"continue", "declare", "readonly", "typeset", "eval", "exec",
...
const HTML_RULES: LanguageRules = {
	keywords: new Set([
		...
		"h1", "h2", "h3", "h4", "h5", "h6", "script", "style", "link", "meta",
...
const C_RULES: LanguageRules = {
	keywords: new Set([
		...
		"volatile", "while",
		// C++ additions
		"class", "template", "namespace", "using", "virtual", "override", "final",
		"public", "private", "protected", "new", "delete", "try", "catch", "throw",
		"noexcept", "constexpr", "decltype", "nullptr", "this", "operator",
		"friend", "explicit", "mutable", "static_cast", "dynamic_cast",
		"reinterpret_cast", "const_cast", "typeid", "typename",
		"true", "false", "NULL",
	]),
	typeKeywords: new Set([
		"int", "char", "void", "float", "double", "long", "short", "unsigned",
		"signed", "bool", "size_t", "ssize_t", "ptrdiff_t", "intptr_t",
		"uint8_t", "uint16_t", "uint32_t", "uint64_t",
		"int8_t", "int16_t", "int32_t", "int64_t",
		"FILE", "string", "vector", "map", "set", "list", "queue", "stack",
		"shared_ptr", "unique_ptr", "weak_ptr", "pair", "tuple", "array",
...
const JAVA_RULES: LanguageRules = {
	...
	typeKeywords: new Set([
		...
		"Optional", "Stream", "Collection", "Iterable", "Comparable", "Serializable",
...
const RUBY_RULES: LanguageRules = {
	...
	typeKeywords: new Set([
		...
		"Range", "Regexp", "IO", "File", "Dir", "Time", "Struct",
...
const SQL_RULES: LanguageRules = {
	keywords: new Set([
		...
		"schema", "grant", "revoke", "commit", "rollback", "savepoint",
		...
		"union", "all", "intersect", "except", "distinct", "as", "case",
		"when", "then", "else", "end", "if", "begin", "declare", "cursor",
		"fetch", "open", "close", "with", "recursive", "returns", "function",
		"procedure", "trigger", "primary", "key", "foreign", "references",
	...
	typeKeywords: new Set([
		...
		"nvarchar", "ntext", "binary", "varbinary", "blob", "clob",
		"date", "time", "datetime", "timestamp", "boolean", "bool",
		"serial", "uuid", "json", "jsonb", "xml", "array",
	]),
	lineComment: "--",
	blockCommentStart: "/*",
	blockCommentEnd: "*/",
...
export function tokenizeLine(line: string, rules: LanguageRules): Token[] {
	...
	while (pos < line.length) {
		...
		const numMatch = line.slice(pos).match(/^(?:0[xX][0-9a-fA-F_]+|0[bB][01_]+|0[oO][0-7_]+|[\d_]+(?:\.[\d_]+)?(?:[eE][+-]?\d+)?n?)/);
