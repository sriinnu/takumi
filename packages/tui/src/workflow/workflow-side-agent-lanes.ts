...
import { executeNativeTool, hasNativeTool, parseJsonToolOutput } from "../commands/app-command-macros.js";
...
export async function runNativeSideAgentLanes(
	ctx: AppCommandContext,
	commandName: string,
...
export async function runNativeSideAgentQuestionLanes(
	...
	return runNativeSideAgentLanes(ctx, commandName, lanes);
}
